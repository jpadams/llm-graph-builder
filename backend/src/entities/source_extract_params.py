...
class SourceScanExtractParams(BaseModel):
    ...
    schemaSpec: Optional[str] = Field(None, description="JSON-encoded SchemaSpec (typed) — node/relationship/property declarations forwarded to neo4j-graphrag's GraphSchema")
